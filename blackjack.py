...
def deal_card(frame):
    # pop next card off the top of deck and add to back of pack
...
def score_hand(hand):
    ...
    # Only 1 ace can have value 11, and value 1 from 2nd ace onwards
    score = 0
    ace = False
    for next_card in hand:
        ...
        # If we bust, check for ace and minus 10
        if score > 21 and ace:
            score -= 10
            ace = False
    return score
...
# Set up the screen for player and dealer
